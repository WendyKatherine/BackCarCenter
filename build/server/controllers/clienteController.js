...
class ClienteController {
    ...
    listCliente(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const cliente = yield database_1.default.query('SELECT * FROM cliente WHERE idcliente = ?', [id]);
            if (cliente.length > 0) {
    ...
    updateCliente(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const id = req.params.id;
            yield database_1.default.query('UPDATE cliente set ? WHERE idcliente = ?', [req.body, id]);
    ...
    deleteCliente(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const id = req.params.id;
            yield database_1.default.query('DELETE FROM cliente WHERE idcliente = ?', [id]);
